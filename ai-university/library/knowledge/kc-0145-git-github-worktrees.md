...
**Why it matters:** Version control lets you roll back safely, collaborate, and move a project across devices. Work trees are the key to running several coding agents at once on the same project without them overwriting each other's files.
...
**Original example to invent:** The source runs parallel feature work via work trees. Describe a scenario (e.g., building two site sections at once) that benefits from isolated branches. Avoid the source's "like your executive assistant" portability analogy.
