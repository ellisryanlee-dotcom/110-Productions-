...
topics: [process-design, planning, wireframing, scoping]
...
**Why it matters:** Most people jump straight into dragging nodes and end up with messy, fragile, non-modular workflows that need heavy rework after going live and are hard to hand off or explain. Front-loading a small amount of planning saves large amounts of downstream time and rework.

**The moves:**
1. Map the process on paper first — break it into clear, detailed steps.
2. Answer the scoping questions: who, when, trigger, data source, data handling, final outcome.
3. Wireframe the flow before building it in the tool.
4. Get alignment with the client or team on the mapped process before construction.
5. Only then build it in the platform.
